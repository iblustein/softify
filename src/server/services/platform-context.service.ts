...
export function getDemoPlatformContext(): PlatformContext {
  ...
  const agentDefinitions: AgentDefinition[] = [
    {
      ...
      systemInstruction: "You are the Store Setup Agent. You analyze Shopify settings, configure store parameters, read current metadata, and propose product structures or settings updates.",
    ...
    },
    {
      ...
      description: "Inspects active Shopify themes.",
    ...
    },
    {
      id: "agent_design",
      name: "Design Agent",
      description: "Optimizes visual content, store layout parameters.",
  ...
  const enabledTools: ToolDefinition[] = ENABLED_TOOLS;
