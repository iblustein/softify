...
| **10.13** | Real-Store Product Readiness | **Planned** | Shopify connection status clarity, scope/permission checks, store readiness checklist, merchant-facing state clarity, bulk UX polish | Planned |
